...
const HotdogClassifier = () => {
  ...
  return (
    <div className="max-w-4xl flex flex-col items-center gap-6 mx-auto">
      {/* Header */}
            ...
            <div className="grid grid-cols-5 gap-2">
              {knnResponse.map((response) => (
                <div key={response.key}>
                  ...
                  <div
                    className={twMerge(
                      "text-center bg-green-500 text-white",
                      response.distance > 0.6 && "bg-orange-500",
                      response.distance > 0.9 && "bg-red-500"
                    )}
                  >
